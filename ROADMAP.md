...
- [ ] Native OS input injection, audio return, and end-to-end haptics (Linux reference capture/audio and X11 keyboard/pointer adapter added; compiled package, uinput/gamepad, and Windows/macOS implementations remain pending).
