...
node --check desktop/electron/preload.mjs
...
node --test desktop/electron/security.test.mjs desktop/electron/runtime-policy.test.mjs desktop/electron/provider-session.test.mjs desktop/electron/power-runtime.test.mjs desktop/electron/tray-policy.test.mjs desktop/electron-builder.test.mjs
