...
required_files=(
  ...
  native/windows/src/bindings.cpp
  native/windows/index.mjs
  native/windows/package.json
  native/windows/package.test.mjs
  native/desktop/reference-adapter.mjs
  native/desktop/reference-adapter.test.mjs
  native/macos/CMakeLists.txt
  native/macos/src/bindings.mm
  native/macos/index.mjs
  native/macos/package.json
  native/macos/package.test.mjs
  native/linux/CMakeLists.txt
  native/linux/src/bindings.cpp
  native/linux/index.mjs
  native/linux/package.json
  native/linux/package.test.mjs
  ...
  scripts/roadmap/acceptance.mjs
  scripts/roadmap/acceptance.test.mjs
  ...
  src/frontend/emulation/host-launch.mjs
  src/frontend/emulation/host-launch.test.mjs
  host/agent.mjs
  ...
  host/input.mjs
  host/input.test.mjs
  host/rumble-passthrough.mjs
  host/rumble-passthrough.test.mjs
  host/audio.mjs
  host/audio.test.mjs
  docs/transport.md
  docs/deployment.md
  ...
  src/frontend/settings/control.mjs
  src/frontend/settings/control.test.mjs
  ...
  src/frontend/session/power-policy.mjs
  src/frontend/session/power-policy.test.mjs
  ...
  desktop/electron/security.mjs
  desktop/electron/runtime-policy.mjs
  desktop/electron/startup-policy.mjs
  desktop/electron/startup-policy.test.mjs
  desktop/electron/diagnostic-log.mjs
  desktop/electron/diagnostic-log.test.mjs
  desktop/electron/provider-session.mjs
  desktop/electron/provider-session.test.mjs
  desktop/electron/power-runtime.mjs
  desktop/electron/power-runtime.test.mjs
  desktop/electron/tray-policy.mjs
  desktop/electron/tray-policy.test.mjs
  ...
  src/frontend/player/media-session.mjs
  src/frontend/player/media-session.test.mjs
  ...
  src/frontend/player/wake-lock.mjs
  src/frontend/player/wake-lock.test.mjs
  ...
  src/frontend/pwa/install.mjs
  src/frontend/pwa/install.test.mjs
  ...
  src/frontend/readiness/status.mjs
  src/frontend/readiness/status.test.mjs
...
node --check scripts/chromium/bootstrap.mjs
...
node --check src/frontend/session/power-policy.mjs
...
node --check scripts/roadmap/acceptance.mjs
...
node --check host/rumble-passthrough.mjs
node --check host/audio.mjs
node --check src/frontend/player/player.mjs
node --check desktop/electron/main.mjs
node --check desktop/electron/preload.cjs
node --check desktop/electron/security.mjs
node --check desktop/electron/runtime-policy.mjs
node --check desktop/electron/startup-policy.mjs
node --check desktop/electron/diagnostic-log.mjs
node --check desktop/electron/provider-session.mjs
node --check desktop/electron/power-runtime.mjs
node --check desktop/electron/tray-policy.mjs
node --check src/frontend/player/transport-config.mjs
node --check src/frontend/player/media.mjs
node --check src/frontend/player/media-session.mjs
node --check src/frontend/player/connection.mjs
node --check src/frontend/player/immersive.mjs
node --check src/frontend/player/wake-lock.mjs
...
node --check src/frontend/pwa/install.mjs
...
node --check src/frontend/settings/control.mjs
...
node --check src/frontend/emulation/host-launch.mjs
node --check native/windows/index.mjs
node --check native/macos/index.mjs
