...
const IMAGE =
  'jrottenberg/ffmpeg@sha256:1275eb6dbd392e5bf1711d8ce9af7f2a5d7e7b198cad632764682e450a9eeeb7';
...
const args = [
  ...
  '--volume',
  `${runtime}/pulse:/tmp/spartan-pulse:ro`,
  '--env',
  'PULSE_SERVER=unix:/tmp/spartan-pulse/native',
  IMAGE,
  'ffmpeg',
