...
test('host capabilities expose optional WebRTC adapter state without module details', () => { const capabilities = normalizeHostCapabilities({webrtc: {adapters: [{id: 'werift', state: 'available', module: {secret: true}}, {id: 'unknown', state: 'broken'}]}}); assert.deepEqual(capabilities.webrtc, {adapters: [{id: 'werift', state: 'available'}], ready: true}); });
