...
const virtualGamepadBackend = String(args.get('virtual-gamepad-backend') || process.env.SPARTAN_VIRTUAL_GAMEPAD_BACKEND || 'Automatic').trim();
const virtualGamepadDevice = String(args.get('virtual-gamepad-device') || process.env.SPARTAN_VIRTUAL_GAMEPAD_DEVICE || '').trim() || undefined;
