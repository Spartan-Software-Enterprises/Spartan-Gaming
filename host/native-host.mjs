 ...
 */
export function createNativeWeriftHostFromPlatformBindings({bindings, platform = bindings?.platform, captureOptions = {}, audioOptions = {}, permissions = {}, includeAudio = true, width = 1920, height = 1080, framerate = 60, codec = 'h264', bitrateKbps = 10000, audioCodec = 'opus', audioBitrateKbps = 128, audioPacketizer, ...options} = {}) {
