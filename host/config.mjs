...
const KEYS = new Set(['platform', 'hostId', 'hostName', 'bind', 'port', 'nativePackage', 'virtualGamepadPackage', 'virtualGamepadBackend', 'virtualGamepadDevice', 'virtualGamepadDevices', 'enableInput', 'enableNativeMedia', 'enableNativeAudio', 'audioSource', 'audioBackend', 'tlsKey', 'tlsCert', 'allowedOrigins', 'maxConnections', 'maxMessagesPerSecond']);
