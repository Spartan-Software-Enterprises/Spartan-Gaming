...
const KEYS = new Set(['platform', 'hostId', 'hostName', 'bind', 'port', 'nativePackage', 'virtualGamepadPackage', 'virtualGamepadBackend', 'virtualGamepadDevice', 'virtualGamepadDevices', 'controllerPolicy', 'enableInput', 'enableNativeMedia', 'enableNativeAudio', 'audioSource', 'audioBackend', 'tlsKey', 'tlsCert', 'allowedOrigins', 'maxConnections', 'maxMessagesPerSecond']);
