...
test('Electron runtime policy defaults to throttling and accepts the explicit performance setting', () => {
  assert.deepEqual(normalizeElectronRuntimePolicy(), {backgroundApps: false, globalShortcut: null, backgroundThrottling: true, powerMode: 'Balanced', doNotTrack: false, blockThirdPartyCookies: false, permissionPrompts: 'Ask per site'});
  assert.deepEqual(normalizeElectronRuntimePolicy({backgroundApps: true, globalShortcut: 'CommandOrControl+Shift+G', backgroundThrottling: false, powerMode: 'Performance', doNotTrack: true, blockThirdPartyCookies: true, permissionPrompts: 'Ask every time'}), {backgroundApps: true, globalShortcut: 'CommandOrControl+Shift+G', backgroundThrottling: false, powerMode: 'Performance', doNotTrack: true, blockThirdPartyCookies: true, permissionPrompts: 'Ask every time'});
  assert.deepEqual(normalizeElectronRuntimePolicy({backgroundThrottling: false, powerMode: 'Battery saver'}), {backgroundApps: false, globalShortcut: null, backgroundThrottling: true, powerMode: 'Battery saver', doNotTrack: false, blockThirdPartyCookies: false, permissionPrompts: 'Ask per site'});
  assert.deepEqual(normalizeElectronRuntimePolicy({backgroundApps: 'true', globalShortcut: 'F1', backgroundThrottling: 'false', powerMode: 'unsupported', doNotTrack: 'true', permissionPrompts: 'unsupported'}), {backgroundApps: false, globalShortcut: null, backgroundThrottling: true, powerMode: 'Balanced', doNotTrack: false, blockThirdPartyCookies: false, permissionPrompts: 'Ask per site'});
});
