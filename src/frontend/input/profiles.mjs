...
export const BUILTIN_CONTROLLER_PROFILES = Object.freeze([
  ...
  createControllerProfile({id: 'xbox-adaptive-layout', name: 'Xbox Adaptive Controller', deviceMatch: 'Xbox Adaptive', bindings: {...DEFAULT_BINDINGS, profile: 'button-10', menu: 'button-11'}}),
  ...
  createControllerProfile({id: 'playstation-portal-layout', name: 'PlayStation Portal', deviceMatch: 'PlayStation Portal', bindings: {...DEFAULT_BINDINGS, confirm: 'button-1', cancel: 'button-0', touchpad: 'button-13'}}),
  ...
  createControllerProfile({id: 'wii-u-pro-layout', name: 'Nintendo Wii U Pro Controller', deviceMatch: 'Wii U Pro|WUP', bindings: {...DEFAULT_BINDINGS, confirm: 'button-1', cancel: 'button-0'}}),
  ...
  createControllerProfile({id: 'logitech-wheel-layout', name: 'Logitech racing wheel', deviceMatch: 'Logitech.*G(29|920|923)|Logitech Racing', bindings: {accelerate: 'axis-2-positive', brake: 'axis-3-positive', steer: 'axis-0', clutch: 'axis-4-positive', handbrake: 'button-0', pause: 'button-9'}}),
  createControllerProfile({id: 'thrustmaster-wheel-layout', name: 'Thrustmaster racing wheel', deviceMatch: 'Thrustmaster.*(T150|T300|TX|TS)|Thrustmaster', bindings: {accelerate: 'axis-2-positive', brake: 'axis-3-positive', steer: 'axis-0', clutch: 'axis-4-positive', handbrake: 'button-0', pause: 'button-9'}}),
  ...
  createControllerProfile({id: 'hotas-layout', name: 'HOTAS flight stick', deviceMatch: 'HOTAS|VKB|Winwing|Thrustmaster.*(T.Flight|HOTAS)', bindings: {pitch: 'axis-1', roll: 'axis-0', yaw: 'axis-2', throttle: 'axis-3', fire: 'button-0', pause: 'button-9'}}),
