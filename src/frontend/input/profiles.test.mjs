...
test('built-in profiles are valid and immutable', () => { assert.equal(BUILTIN_CONTROLLER_PROFILES.length, 3); assert.equal(Object.isFrozen(BUILTIN_CONTROLLER_PROFILES[0]), true); });
