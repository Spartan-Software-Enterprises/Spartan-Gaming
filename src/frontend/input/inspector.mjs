...
export function resolveControllerPreferences(settings = {}) { const {version, inputLatency, deadzone, ...policy} = controllerPolicyFromSettings(settings); return Object.freeze({...policy, inputPolling: inputLatency}); }
