...
export function createSessionPreferences(settings = {}, capabilities, workspace = null, controllerProfiles = []) {
  ...
  const requestedControllerProfile = resolveWorkspaceControllerProfile(workspace || {}, String(settings['controllers.defaultProfile'] || 'Auto-detect'));
