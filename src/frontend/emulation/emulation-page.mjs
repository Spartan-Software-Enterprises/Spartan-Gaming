...
let pendingBrowserAdapterManifest = null;
const coreList = document.querySelector('[data-core-list]');
const fileList = document.querySelector('[data-file-list]');
const gameFolderLabel = document.querySelector('[data-game-folder-label]');
const gameFolderInput = document.querySelector('[data-game-folder]');
