...
export function createPlayerState(overrides = {}) {
  const state = {status: 'idle', quality: 'balanced', latencyMs: null, packetLossPct: 0, overlayVisible: true, diagnosticsVisible: false, gamepadConnected: false, error: null, ...overrides};
