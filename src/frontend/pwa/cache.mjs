...
export const PRECACHE_URLS = Object.freeze([
  ...
  '/providers/catalog.json', '/emulators/catalog.json', '/games/catalog.json',
]);
...
export function isCatalogRequest(url) { return /\/(providers|emulators|games)\/catalog\.json$/.test(new URL(url, 'https://spartangaming.invalid').pathname); }
