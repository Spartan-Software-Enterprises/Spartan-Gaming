...
function saveState() {
  ...
  globalThis.spartanElectron?.applyRuntimeSettings?.({backgroundThrottling: state['performance.backgroundThrottling'] !== false, powerMode: state['performance.powerMode'], doNotTrack: state['privacy.doNotTrack'] === true, blockThirdPartyCookies: state['privacy.blockThirdPartyCookies'] === true, permissionPrompts: state['privacy.permissionPrompts']});
