...
export const SETTINGS_ACTIONS = Object.freeze({
  ...
  'updates.checkNow': Object.freeze({kind: 'status', message: 'Update service is not configured in this frontend build; use the signed release channel when available.'}),
  'updates.releaseNotes': Object.freeze({kind: 'external', href: 'https://github.com/Spartan-Software-Enterprises/Spartan-Gaming/releases'}),
});

export function resolveSettingsAction(key) { return SETTINGS_ACTIONS[key]; }
