...
export const settingsCategories = [
  ...
  },
  {
    id: 'controllers', label: 'Controllers', icon: '⌁', description: 'Gamepads, HID devices, mappings, and rumble.', settings: [
      select('controllers.defaultProfile', 'Default controller profile', 'Profile used for new games and providers.', ['Auto-detect', 'Xbox layout', 'Xbox Elite / Elite 2', 'PlayStation layout', 'DualSense / DualShock', 'DualSense Edge', 'Nintendo layout', 'Joy-Con pair', 'Switch Pro Controller', 'Steam Deck', 'Steam Controller', 'Stadia controller', '8BitDo / XInput', 'Arcade stick', 'Racing wheel and pedals', 'Flight stick and throttle', 'Generic HID controller', 'Keyboard and mouse'], 'Auto-detect'),
