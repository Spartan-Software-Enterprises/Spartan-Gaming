...
export const settingsCategories = [
  ...
  },
  {
    id: 'controllers', label: 'Controllers', icon: '⌁', description: 'Gamepads, HID devices, mappings, and rumble.', settings: [
      select('controllers.defaultProfile', 'Default controller profile', 'Profile used for new games and providers.', ['Auto-detect', 'Xbox layout', 'Xbox Elite / Elite 2', 'Xbox Adaptive Controller', 'PlayStation layout', 'DualSense / DualShock', 'DualSense Edge', 'PlayStation Portal', 'Nintendo layout', 'Joy-Con pair', 'Switch Pro Controller', 'Nintendo Wii U Pro Controller', 'Steam Deck', 'Steam Controller', 'Stadia controller', '8BitDo / XInput', 'Backbone / Razer Kishi', 'Arcade stick', 'Racing wheel and pedals', 'Logitech racing wheel', 'Thrustmaster racing wheel', 'Flight stick and throttle', 'HOTAS flight stick', 'Generic HID controller', 'Keyboard and mouse'], 'Auto-detect'),
