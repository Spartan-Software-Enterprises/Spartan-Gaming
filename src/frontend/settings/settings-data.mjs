...
export const settingsCategories = [
  ...
  },
  {
    id: 'controllers', label: 'Controllers', icon: '⌁', description: 'Gamepads, HID devices, mappings, and rumble.', settings: [
      ...
      select('controllers.virtualGamepadBackend', 'Virtual gamepad backend', 'Choose the platform bridge used when a host or game needs a virtual controller; unavailable bridges fail closed.', ['Automatic', 'Browser Gamepad', 'Linux uinput', 'Windows XInput', 'macOS GameController', 'Disabled'], 'Automatic'),
