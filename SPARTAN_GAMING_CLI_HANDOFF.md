...
The active branch is `main`; verify the current commit with `git log -1 --oneline`. The latest prerelease is `v0.1.0-beta.7`. The canonical checkout is `/home/ubuntu/Spartan-Gaming` on the KVM. Current HEAD is `d92e090`.
